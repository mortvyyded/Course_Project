...
namespace Elvira_881
{
    public partial class Form5 : Form
    {
        ...
        private void LoadData()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM `info` WHERE `Подтверждение` = 2", db.getConnection());
        ...
        public void Export_Data_To_Word(DataGridView DGV, string filename)
        {
            ...
            if (DGV.Rows.Count != 0)
            {
...

                {
                    ...
                    headerRange.Text = "Выполненные записи";
