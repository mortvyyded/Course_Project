...
lbl1 = Label(window, fg='#f00', text="U=", font=("Arial Bold", 24))
...
U = tk.IntVar()
nameEntered1 = ttk.Entry(window, width = 30, foreground='#f00', textvariable = U)
...
image = Image.open("Безымянный4.png")
