...
lbl1 = Label(window, fg='#f00', text="Ответ S =", font=("Arial Bold", 24))
lbl1.grid(column=0, row=0) 
lbl2 = Label(window, fg='#f00', text="v =", font=("Arial Bold", 24))
...
S = tk.IntVar()
nameEntered1 = ttk.Entry(window, width = 30, foreground='#f00', textvariable = S)
nameEntered1.grid(column = 1, row = 0)
v = tk.IntVar()
nameEntered2 = ttk.Entry(window, width = 30, foreground='#f00', textvariable = v)
