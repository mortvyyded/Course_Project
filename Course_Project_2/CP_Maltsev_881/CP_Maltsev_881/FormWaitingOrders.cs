...
{
    public partial class FormWaitingOrders : Form
    {
        public string s;

        public FormWaitingOrders()
        {
            InitializeComponent();
        ...
        public void Export_Data_To_Word(DataGridView DGV, string filename)
        {
            ...
            if (DGV.Rows.Count != 0)
            {
                ...
                foreach (Word.Section section in oDoc.Application.ActiveDocument.Sections)
                {
                    ...
                    headerRange.Text = "Список заявок на обработке";
    ...
    ref oMissing, ref oMissing);
        ...
        private void FormWaitingOrders_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("UPDATE `info` SET `Оформление`= 0 WHERE `id` =" + s, database.getConnection());
