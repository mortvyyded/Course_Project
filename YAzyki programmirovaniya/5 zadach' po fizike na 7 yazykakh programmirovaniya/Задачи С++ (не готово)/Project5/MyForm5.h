...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(501, 69);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(181, 92);
			...
			this->label1->Text = L"Какое количество теплоты выделится за 25 мин в обмотке электродвигателя, если ее "
				L"\r\nактивное сопротивление равно 125 Ом, а сила тока, протекающего в ней, равна 1,"
				L"2 А\?";
			// 
			// MyForm5
			// 
			...
			this->ClientSize = System::Drawing::Size(738, 291);
