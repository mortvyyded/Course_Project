...
lbl1 = Label(window, fg='#f00', text="Ftp=", font=("Arial Bold", 24))
lbl1.grid(column=0, row=0) 
lbl2 = Label(window, fg='#f00', text="A=", font=("Arial Bold", 24))
...
Ftp = tk.IntVar()
nameEntered1 = ttk.Entry(window, width = 30, foreground='#f00', textvariable = Ftp)
...
image = Image.open("Безымянный2.png")
