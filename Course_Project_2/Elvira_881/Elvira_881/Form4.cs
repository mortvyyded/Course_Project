...
namespace Elvira_881
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("INSERT INTO `info` (`ФИО`, `Номер телефона`, `Услуга`, `Дата для записи`, `Сотрудники`) VALUES (@name, @number, @service, @date, @staff)", db.getConnection());
            ...
            command.Parameters.Add("@staff", MySqlDbType.VarChar).Value = textBox4.Text;
